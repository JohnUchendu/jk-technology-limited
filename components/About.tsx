      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="max-w-3xl mx-auto space-y-8 animate-fade-in-delay">
          ...
          <p className="text-lg sm:text-xl text-gray-700 leading-relaxed animate-fade-in-delay-4">
            Under John'&quot's leadership, JKTL has successfully delivered enterprise software solutions for corporate clients like <strong className="text-blue-900">K.K. Ubani & Co.</strong> and helped countless SMEs adopt digital workflows. Our tools are designed to save time, reduce errors, and accelerate business growth.
          </p>
